...
for _, src in ipairs(os.files("tests/pos/*.nc")) do
    ...
    target("test_" .. name)
        ...
        if name == "ir_ptr" or name == "ir_demo" or name == "ir_prefix" or name == "ir_array" or name == "ir_switch" or name == "ir_struct" or name == "ir_vis" or name == "ir_builtin" or name == "ir_multi" then
            set_default(false)
        end
    target_end()
end
...
local IR_ONLY = {ir_ptr = true, ir_prefix = true, ir_array = true, ir_switch = true, ir_struct = true, ir_vis = true, ir_builtin = true, ir_multi = true}
