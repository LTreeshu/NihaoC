...
local IR_ONLY = {ir_ptr = true, ir_prefix = true, ir_array = true, ir_switch = true, ir_struct = true, ir_vis = true, ir_builtin = true, ir_multi = true, ir_mr = true, ir_float = true, ir_slice = true, ir_fcall = true, ir_narrow = true, ir_narray = true, ir_conv = true, ir_str = true, ir_sparam = true, ir_bitfield = true}
